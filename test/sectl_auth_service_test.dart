  ...
  group('SectlAuthService', () {
    ...
    test('trusted web callback URI only accepts configured app origin', () {
      final trustedUri = parseTrustedWebAppCallbackUri(
        'https://secrandom-lite.sectl.cn/?code=abc&state=state-123#ignored',
      );
      ...
      expect(trustedUri?.origin, 'https://secrandom-lite.sectl.cn');
    ...
    test(
      ...
      () {
        final uri = parseTrustedWebAppCallbackUri(
          'https://user:pass@secrandom-lite.sectl.cn/?code=abc',
        );
      ...
      () {
        expect(
          isTrustedWebPopupCallbackMessage(
            ...
            href:
                'https://secrandom-lite.sectl.cn/?code=abc&state=state-123',
            eventOrigin: 'https://secrandom-lite.sectl.cn',
